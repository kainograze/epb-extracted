	...
	public void OnGUI()
	{
		checked
		{
			if (DisplayGUITip)
			{
				...
				GUI.Box(new Rect(unchecked(Screen.width / 2) - 100, unchecked(Screen.height / 2) + unchecked(Screen.height / 4), 200f, 60f), "Pull up for maximum lift!", NormalSizeComicText);
			}
		}
	}
